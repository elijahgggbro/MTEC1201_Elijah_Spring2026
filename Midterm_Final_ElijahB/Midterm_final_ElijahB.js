...
Welcome to an interactive journey through my progress in P5
...
Press R at any time to go back to the menu.

Press Space at any time to reset Claw Machine.
...
// left and right hold press

let moveLeft = false;
let moveRight = false;

// speed of claw movement x
let clawSpeed = 3;
...
// plus 3 new features to sketch 2!!!:
// redesigned frame
// title text
// score
...
// bottom right
fill(100);
ellipse(875,510,30,30);

stroke(30);
line(865,500,885,520);

fill (120);
line(885,500,865,520);
...
fill(250,100,20);
textSize(60);
text("Claw Machine",width-450,height-750);
...
// new score display
fill( 30);
text("Score: " + score +"/2",width/2-330,110);
