...
function drawMenu() {
  ...
  noStroke(); 
  textSize(90);
  text("three sketches", width/2, 120);

  fill(140);
  textSize(30);
  text("press R at any time to return here", width/2, 165);
